...
export default function HeroSection() {
  return (
    <section id="hero" className="bg-gradient-to-b from-main-color to-secondary-50 min-h-screen
                    flex flex-col items-center -mt-12
                    md:flex-row-reverse">
       <div className="min-h-screen flex flex-col justify-start items-center w-full
                       md:h-full md:w-1/2 md:justify-start pt-46 md:pl-20 
       ...
       <div className="absolute left-0 top-1/2 md:top-auto">
